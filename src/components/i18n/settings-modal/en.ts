export const settingsModalEn = {
  ...
  showHeaderActionLabels: 'Show top button labels',
  showSideToolbarLabels: 'Show sidebar labels',
  ...
  previewNextTitle: 'Branch',
  previewNextBody: 'On the mountain, there was a temple.',
  valueLabel: 'Value',
