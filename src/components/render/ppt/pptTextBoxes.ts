...
export const PPT_DEFAULT_TEXT_BOX_LAYOUTS: Record<PptTextOverrideTarget, PptTextBoxLayout> = {
  'cover-title': { x: 160, y: 330, width: 720, height: 130, rotation: 0, visible: true },
  'cover-subtitle': { x: 160, y: 485, width: 620, height: 56, rotation: 0, visible: true },
  'cover-description': { x: 160, y: 555, width: 660, height: 90, rotation: 0, visible: true },
