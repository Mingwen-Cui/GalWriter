    ...
    <>
      ...
      {open &&
        ...
        createPortal(
          ...
          >
            <section
              className="flex max-h-[min(760px,calc(100vh-32px))] w-[min(720px,calc(100vw-32px))] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white text-slate-900 shadow-2xl"
              role="dialog"
              aria-modal="true"
              ...
              <div className="min-h-0 space-y-5 overflow-y-auto p-5">
                ...
                <section className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  {localFonts.length ? (
                    <div className="mt-3 grid max-h-52 grid-cols-1 gap-2 overflow-y-auto sm:grid-cols-2">
                      {localFonts.map((font) => {
                        const option = { label: font.family, value: fontFamilyValue(font.family) };
                        const inCommon = commonOptions.some((item) => item.value === option.value);
                        return (
                          <div
                            key={font.family}
                ...
                <section className="rounded-xl border border-amber-200 bg-amber-50 p-4">
                  ...
                  <button
                    ...
                    className="mt-3 flex items-center gap-2 rounded-lg bg-amber-600 px-3 py-2 text-xs font-bold text-white hover:bg-amber-700 disabled:cursor-not-allowed disabled:opacity-50"
                  >
